...
description: 'Complete guide to implementing JWT authentication in App CR with code examples'
---

## Overview

App CR uses **JSON Web Tokens (JWT)** for stateless authentication. This guide covers the complete implementation including token generation, validation, and best practices.
